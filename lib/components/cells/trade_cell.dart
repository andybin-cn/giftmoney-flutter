          ...
          Expanded(child: Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Text(widget.trade.formatValue, style: TextStyle(fontSize: 16, color: widget.trade.type == SQLTradeType.inAccount ? AppColor.mainAppColor : AppColor.mainGreen))),
